...
function CadastroUsuario() {
    ...
    //Abaixo um exemplo de state. State é uma varíavel
    ...
    //a função abaixo aguarda um evento do tipo any e dentro dele o setfotos chama o event com o alvo em arquivos usando o primeiro array
    ...
    function cadastrarUsuario(event: any){
        ...
        //append significa adicionar ao final
        //blob significa que é possível adicionar um tipo binario
        ...
        //a api irá mandar o endpoin ao users
        api.post("users", formdata).then( (response) =>{
            console.log(response)
            alert("usuario criado com sucesso")
            //navegação para login

            //then fará quando der certo, catch quando der erro
        } ).catch( (error) => {
            console.log(error)
        } )
                    ...
                    <form onSubmit={ cadastrarUsuario } className="cad_formulario" method="POST">
                        <div className="cad_box_input">
                            ...
                            <input
                                type="text"
                                id="nome"
                                //o evento abaixo está usando uma função anonima que está apontando para var setNome onde o evento está em alvo no valor que o input irá receber
                        ...
                        <div className="cad_box_input">
                            ...
                            <input
                                type="file"
                                id="foto"
                                //Toda vez que alterar o valor do input, irá chamar esta funçao que irá atualizar o valor
