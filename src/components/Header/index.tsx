...
//Importante fazer a importação do link sendo este responsável pela comunicaçào com outras páginas
...
function Header() {
    ...
    //state para armazenar as informações que está logado
    const [ usuarioLogado, setUsuarioLogado ] = useState<any>()


    //no useeffect, assim que o header carregar irá pegar  funçao e carregar, se nao tiver fará nada
    useEffect(() => {
                ...
                <div className="container header_conteudo">
                    ...
                    <nav>
                        <div id="menu_links" className="menu_links">
                            {/* <a href="../Homxe/index.html">home</a> */}`
                            <Link to={'/'} >home</Link>
                        ...
                        {/* If ternário */}
                        {
                            ...
                            usuarioLogado ? 
                            //No final, fará com que o nome seja dividido e use o primeiro indice o array caso seja um nome com varios caracteres
